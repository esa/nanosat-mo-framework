...
- ``provider.properties`` (available in ``sdk-execution-environment/src/main/resources/space-app-root``)
- ``settings.properties`` and ``transport.properties`` (available in ``sdk-execution-environment/src/main/resources/space-common``)
...
- ``consumer.properties`` (available in ``sdk-execution-environment/src/main/resources/ground-consumer-root``)
