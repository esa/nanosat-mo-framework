...
1. Run the Supervisor, go to **sdk/sdk-package/target/nmf-sdk-4.0-SNAPSHOT/home/nmf/nanosat-mo-supervisor-sim/** and run **nanosat-mo-supervisor-sim.sh**.

2. Run the CTT, go to **sdk/sdk-package/target/nmf-sdk-4.0-SNAPSHOT/home/nmf/consumer-test-tool/** and run **consumer-test-tool.sh**.
