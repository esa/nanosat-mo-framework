...
public class GPSSoftSimAdapterTest {
    ...
    public void testTIMEAFormat() throws IOException {
        ...
        esa.mo.platform.impl.provider.softsim.GPSSoftSimAdapter gPSSoftSimAdapter = new esa.mo.platform.impl.provider.softsim.GPSSoftSimAdapter(eSASimulator,
                                                                                                                                                pcAdapter);
        ...
        String expectedRegex = "#TIMEA,\\w{1,8}_?\\d{1,2},0,\\d{1,2}\\.\\d{1,2}," +
                               GPS_REF_TIME_STATUS +
                               ",\\d{4},-?\\d{1,6}\\.\\d{3},[0|1]{8},[\\d|\\w]{4},\\d{1,5};" +
                               CLOCK_MODEL_STATUS +
    ...
    public void testBESTXYZAHeaderFormat() throws IOException {
        ...
        String expectedRegex = "^#BESTXYZA,\\w{1,8}_?\\d{1,2},0,\\d{1,2}\\.\\d{1,2}," +
                               GPS_REF_TIME_STATUS +
