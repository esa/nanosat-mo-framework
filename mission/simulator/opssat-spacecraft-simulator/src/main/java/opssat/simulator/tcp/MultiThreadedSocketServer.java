...
public class MultiThreadedSocketServer extends Thread {
  ...
  private final CentralNode parent;
  private final LinkedList<ClientServiceThreadSender> clientSockets;
  /*
   ...
   */
  private final HashMap<ClientServiceThreadSender, LinkedList<String>> hMapManualCommandsList;
  ...
  class ClientServiceThreadSender extends Thread {
    ...
    public void run() {
      ...
      logger.log(Level.FINE,
          "Sender Accepted Client Address - " + myClientSocket.getInetAddress().getHostName());
