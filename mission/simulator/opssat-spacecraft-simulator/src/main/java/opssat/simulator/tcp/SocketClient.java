    ...
    public void run() {
        while (!connectionEstablished) {
            ...
            try {
                ...
                this.parent.getFromServerQueue().offer("Local;Cannot connect to server @ " + targetURL + ":" + targetPort);
                s = null;
            }
            ...
            try {
                ...
                while (true) {
                    ...
                    try {
                        ...
                        //System.out.println("Received something ["+received.getClass().getName()+"]");
                ...
                this.parent.getFromServerQueue().offer("Local;Receiver;Exception during communication. Server probably closed connection." + ioe);
    ...
    class SocketClientThreadSender extends Thread {
        ...
        public void run() {
            ...
            try {
                ...
                this.parent.getFromServerQueue().offer("Local;Sender;Exception during communication. Server probably closed connection." + ioe);
