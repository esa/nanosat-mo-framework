...
public class SimulatorHeader implements Serializable {
    ...
    public Date parseStringIntoDate(String fieldValue) {
        ...
        if (result != null) {
            ...
            if (Integer.parseInt(originalYear) >= MIN_DATE_YEAR && Integer.parseInt(originalYear) < MAX_DATE_YEAR) {
    ...
    public String toFileString() {
        ...
        return  "#Run the processing of internal models\n" +
                ...
                "keplerElements="   +SimulatorNode.DEFAULT_OPS_SAT_A+";"
                                    +SimulatorNode.DEFAULT_OPS_SAT_E+";"
                                    +SimulatorNode.DEFAULT_OPS_SAT_ORBIT_I+";"
                                    +SimulatorNode.DEFAULT_OPS_SAT_RAAN+";"
                                    +SimulatorNode.DEFAULT_OPS_SAT_ARG_PER+";"
    ...
    public String toString() {
        return "SimulatorHeader{" + "autoStartSystem=" + autoStartSystem + ", autoStartTime=" + autoStartTime + ", timeFactor=" + timeFactor + ", startDate=" + startDate + ", endDate=" + endDate + '}';
    }
