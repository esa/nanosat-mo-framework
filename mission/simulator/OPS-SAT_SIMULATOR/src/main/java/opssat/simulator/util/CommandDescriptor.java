...
public class CommandDescriptor implements Serializable {
    ...
    private String checkSingleFloat(String argument, int argIndex, boolean multiOperation, boolean replace, int subIndex)
    {
    ...
    private String checkSingleInt(String argument, int argIndex, boolean multiOperation, boolean replace, int subIndex)
    {
        String dataOk = "ParseOk";
        try {
    ...
    private String checkSingleLong(String argument, int argIndex, boolean multiOperation, boolean replace, int subIndex)
    {
        String dataOk = "ParseOk";
        try {
    ...
    private String checkSingleDouble(String argument, int argIndex, boolean multiOperation, boolean replace, int subIndex)
    {
        String dataOk = "ParseOk";
        try {
    ...
    private String checkSingleByte(String argument, int argIndex, boolean multiOperation, boolean replace, int subIndex) {
        String dataOk = "ParseOk";
    ...
    private String checkSingleArg(String inputArgListString, int argIndex) {
        ...
        if (index1 > -1 && index2 > -1 && index2 > index1) {
            String argument = inputArgListString.substring(inputArgListString.indexOf("{") + 1, inputArgListString.indexOf("}"));
            if (this.inputArgList.get(argIndex).getType() instanceof String) {
                ...
                dataOk = "setInputArgsFromString;-5;Class type [" + this.inputArgList.get(argIndex).getType().getClass().toString() + "] not treated";
            }
        } else {
    ...
    public String getInputArgs() {
        ...
        int argsCount = 0;
        if (this.logger!=null) this.logger.log(Level.ALL,"inputArgList count is ["+inputArgList.size()+"]");
        for (ArgumentDescriptor obj : inputArgList) {
            if (this.logger!=null) this.logger.log(Level.ALL,"Trying to read from ["+obj.getName()+"]");
