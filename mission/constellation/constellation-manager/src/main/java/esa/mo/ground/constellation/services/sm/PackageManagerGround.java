...
public class PackageManagerGround {
    ...
    public static FindPackageResponse getAllPackages(GroundMOAdapterImpl groundMOAdapter) {
        ...
        try {
            ...
            Logger.getLogger(ConstellationManager.class.getName()).log(Level.SEVERE, null, ex);
        }
        return null;
    }
        ...
        try {
            serviceSMPackageManagement.getPackageManagementStub().install(ids, new PackageManagementAdapter() {
                ...
                public void installAckReceived(org.ccsds.moims.mo.mal.transport.MALMessageHeader msgHeader, org.ccsds.moims.mo.mal.structures.BooleanList integrity, java.util.Map qosProperties) {
                    Logger.getLogger(ConstellationManager.class.getName()).log(Level.INFO, "Installing...");
                }
                ...
                public void installResponseReceived(org.ccsds.moims.mo.mal.transport.MALMessageHeader msgHeader, java.util.Map qosProperties) {
                    Logger.getLogger(ConstellationManager.class.getName()).log(Level.INFO, "Installed successfully!");
                }

                @Override
                public void installAckErrorReceived(org.ccsds.moims.mo.mal.transport.MALMessageHeader msgHeader, org.ccsds.moims.mo.mal.MALStandardError error, java.util.Map qosProperties) {
                ...
                @Override
                public void installResponseErrorReceived(org.ccsds.moims.mo.mal.transport.MALMessageHeader msgHeader, org.ccsds.moims.mo.mal.MALStandardError error, java.util.Map qosProperties) {
                    String msg = "There was an error during the install operation.";
                    Logger.getLogger(ConstellationManager.class.getName()).log(Level.SEVERE, msg, error);
                }
            });
        ...
        try {
            serviceSMPackageManagement.getPackageManagementStub().upgrade(ids, new PackageManagementAdapter() {
                ...
                public void upgradeAckReceived(org.ccsds.moims.mo.mal.transport.MALMessageHeader msgHeader, java.util.Map qosProperties) {
                    Logger.getLogger(ConstellationManager.class.getName()).log(Level.INFO, "Upgrading...");
                }
                ...
                public void upgradeResponseReceived(org.ccsds.moims.mo.mal.transport.MALMessageHeader msgHeader, java.util.Map qosProperties) {
                    Logger.getLogger(ConstellationManager.class.getName()).log(Level.INFO, "Upgraded!");
                }

                @Override
                public void upgradeAckErrorReceived(org.ccsds.moims.mo.mal.transport.MALMessageHeader msgHeader, org.ccsds.moims.mo.mal.MALStandardError error, java.util.Map qosProperties) {
                    JOptionPane.showMessageDialog(null, "There was an error during the upgrade operation.", "Error", JOptionPane.PLAIN_MESSAGE);
                    Logger.getLogger(ConstellationManager.class.getName()).log(Level.SEVERE, "There was an error during the upgrade operation." + "\nException:\n" + error + "\n" + error.toString(), error);
                }

                @Override
                public void upgradeResponseErrorReceived(org.ccsds.moims.mo.mal.transport.MALMessageHeader msgHeader, org.ccsds.moims.mo.mal.MALStandardError error, java.util.Map qosProperties) {
                    JOptionPane.showMessageDialog(null, "There was an error during the upgrade operation.", "Error", JOptionPane.PLAIN_MESSAGE);
                    Logger.getLogger(ConstellationManager.class.getName()).log(Level.SEVERE, "There was an error during the upgrade operation." + "\nException:\n" + error + "\n" + error.toString(), error);
                }
            });
        ...
        try {
            serviceSMPackageManagement.getPackageManagementStub().uninstall(ids, keep, new PackageManagementAdapter() {
                ...
                public void uninstallAckReceived(org.ccsds.moims.mo.mal.transport.MALMessageHeader msgHeader, java.util.Map qosProperties) {
                    Logger.getLogger(ConstellationManager.class.getName()).log(Level.INFO, "Uninstalling...");
                }
                ...
                public void uninstallResponseReceived(org.ccsds.moims.mo.mal.transport.MALMessageHeader msgHeader, java.util.Map qosProperties) {
                    Logger.getLogger(ConstellationManager.class.getName()).log(Level.INFO, "Uninstalled successfully!");
                }

                @Override
                public void uninstallAckErrorReceived(org.ccsds.moims.mo.mal.transport.MALMessageHeader msgHeader, org.ccsds.moims.mo.mal.MALStandardError error, java.util.Map qosProperties) {
                ...
                @Override
                public void uninstallResponseErrorReceived(org.ccsds.moims.mo.mal.transport.MALMessageHeader msgHeader, org.ccsds.moims.mo.mal.MALStandardError error, java.util.Map qosProperties) {
                    String msg = "There was an error during the uninstall operation.";
                    JOptionPane.showMessageDialog(null, msg, "Error", JOptionPane.PLAIN_MESSAGE);
                    Logger.getLogger(ConstellationManager.class.getName()).log(Level.SEVERE, msg, error);
                }
