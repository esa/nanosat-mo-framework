...
public class DatabaseBackend {
    ...
    public void startBackendDatabase(final TransactionsProcessor dbProcessor) {
        ...
        try {
            ...
            query.execute("CREATE TABLE IF NOT EXISTS COMObjectEntity (objectTypeId INTEGER NOT NULL, objId BIGINT NOT NULL, domainId INTEGER NOT NULL, objBody " + blobType + ", providerURI INTEGER, relatedLink BIGINT, timestampArchiveDetails BIGINT, PRIMARY KEY (objectTypeId, objId, domainId))");
