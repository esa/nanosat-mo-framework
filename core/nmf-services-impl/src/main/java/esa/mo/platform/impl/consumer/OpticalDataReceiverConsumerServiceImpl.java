...
public class OpticalDataReceiverConsumerServiceImpl extends ConsumerServiceImpl {
    ...
    /**
     * Creates the OpticalDataReceiver service consumer and starts the consumer connection.
     *
     * @param connectionDetails the connection details of the OpticalDataReceiver service provider
    ...
    /**
     * Creates the OpticalDataReceiver service consumer with no authentication id nor local name prefix.
     *
     * @param connectionDetails the connection details of the OpticalDataReceiver service provider
     * @param comServices the COM services consumer used by this service
     * @throws MALException if the consumer cannot be created
    ...
    /**
     * Returns the OpticalDataReceiver service stub used to invoke operations on the provider.
     *
