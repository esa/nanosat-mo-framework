...
public class MCServicesProvider {
    ...
    public void init(COMServicesProvider comServices, ActionInvocationListener actions,
            ParameterStatusListener monitoringParameters, ExternalStatisticFunctionsInterface statisticFunctions) throws MALException {
        ...
        checkService.init(comServices, parameterManager);
