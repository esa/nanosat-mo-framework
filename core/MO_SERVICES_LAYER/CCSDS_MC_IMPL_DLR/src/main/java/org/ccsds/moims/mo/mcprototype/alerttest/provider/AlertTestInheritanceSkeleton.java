...
/**
 * Provider Inheritance skeleton for AlertTestInheritanceSkeleton service.
 */
public abstract class AlertTestInheritanceSkeleton implements org.ccsds.moims.mo.mal.provider.MALInteractionHandler, org.ccsds.moims.mo.mcprototype.alerttest.provider.AlertTestSkeleton, org.ccsds.moims.mo.mcprototype.alerttest.provider.AlertTestHandler
{
   ...
   */
  public void setSkeleton(org.ccsds.moims.mo.mcprototype.alerttest.provider.AlertTestSkeleton skeleton)
  {
  ...
  public void handleRequest(org.ccsds.moims.mo.mal.provider.MALRequest interaction, org.ccsds.moims.mo.mal.transport.MALMessageBody body) throws org.ccsds.moims.mo.mal.MALInteractionException, org.ccsds.moims.mo.mal.MALException
  {
    switch (interaction.getOperation().getNumber().getValue())
    {
      case org.ccsds.moims.mo.mcprototype.alerttest.AlertTestHelper._GENERATEALERT_OP_NUMBER:
        interaction.sendResponse(new org.ccsds.moims.mo.mal.structures.Union(generateAlert((body.getBodyElement(0, new org.ccsds.moims.mo.mal.structures.Union(Long.MAX_VALUE)) == null) ? null : ((org.ccsds.moims.mo.mal.structures.Union) body.getBodyElement(0, new org.ccsds.moims.mo.mal.structures.Union(Long.MAX_VALUE))).getLongValue(), (org.ccsds.moims.mo.mc.structures.AttributeValueList) body.getBodyElement(1, new org.ccsds.moims.mo.mc.structures.AttributeValueList()), (body.getBodyElement(2, new org.ccsds.moims.mo.mal.structures.Union(Boolean.FALSE)) == null) ? null : ((org.ccsds.moims.mo.mal.structures.Union) body.getBodyElement(2, new org.ccsds.moims.mo.mal.structures.Union(Boolean.FALSE))).getBooleanValue(), interaction)));
        break;
      case org.ccsds.moims.mo.mcprototype.alerttest.AlertTestHelper._ADDALERTDEFINITION_OP_NUMBER:
        interaction.sendResponse(addAlertDefinition((org.ccsds.moims.mo.mc.alert.structures.AlertCreationRequest) body.getBodyElement(0, new org.ccsds.moims.mo.mc.alert.structures.AlertCreationRequest()), interaction));
        break;
      default:
        interaction.sendError(new org.ccsds.moims.mo.mal.MALStandardError(org.ccsds.moims.mo.mal.MALHelper.UNSUPPORTED_OPERATION_ERROR_NUMBER, new org.ccsds.moims.mo.mal.structures.Union("Unknown operation")));
    }
