...
/**
 * Provider Inheritance skeleton for ActionTestInheritanceSkeleton service.
 */
public abstract class ActionTestInheritanceSkeleton implements org.ccsds.moims.mo.mal.provider.MALInteractionHandler, org.ccsds.moims.mo.mcprototype.actiontest.provider.ActionTestSkeleton, org.ccsds.moims.mo.mcprototype.actiontest.provider.ActionTestHandler
{
   ...
   */
  public void setSkeleton(org.ccsds.moims.mo.mcprototype.actiontest.provider.ActionTestSkeleton skeleton)
  {
  ...
  public void handleSubmit(org.ccsds.moims.mo.mal.provider.MALSubmit interaction, org.ccsds.moims.mo.mal.transport.MALMessageBody body) throws org.ccsds.moims.mo.mal.MALInteractionException, org.ccsds.moims.mo.mal.MALException
  {
    switch (interaction.getOperation().getNumber().getValue())
    {
      ...
      case org.ccsds.moims.mo.mcprototype.actiontest.ActionTestHelper._FORCEPRECHECKINVALIDEXCEPTION_OP_NUMBER:
        forcePreCheckInvalidException((body.getBodyElement(0, new org.ccsds.moims.mo.mal.structures.Union(Boolean.FALSE)) == null) ? null : ((org.ccsds.moims.mo.mal.structures.Union) body.getBodyElement(0, new org.ccsds.moims.mo.mal.structures.Union(Boolean.FALSE))).getBooleanValue(), (org.ccsds.moims.mo.mal.structures.UIntegerList) body.getBodyElement(1, new org.ccsds.moims.mo.mal.structures.UIntegerList()), interaction);
        interaction.sendAcknowledgement();
        break;
      case org.ccsds.moims.mo.mcprototype.actiontest.ActionTestHelper._FORCEPRECHECKFAILURE_OP_NUMBER:
        forcePreCheckFailure((body.getBodyElement(0, new org.ccsds.moims.mo.mal.structures.Union(Boolean.FALSE)) == null) ? null : ((org.ccsds.moims.mo.mal.structures.Union) body.getBodyElement(0, new org.ccsds.moims.mo.mal.structures.Union(Boolean.FALSE))).getBooleanValue(), interaction);
        interaction.sendAcknowledgement();
        break;
      case org.ccsds.moims.mo.mcprototype.actiontest.ActionTestHelper._SETFAILURESTAGE_OP_NUMBER:
        setFailureStage((org.ccsds.moims.mo.mal.structures.UInteger) body.getBodyElement(0, new org.ccsds.moims.mo.mal.structures.UInteger()), (org.ccsds.moims.mo.mal.structures.UInteger) body.getBodyElement(1, new org.ccsds.moims.mo.mal.structures.UInteger()), interaction);
        interaction.sendAcknowledgement();
        break;
      case org.ccsds.moims.mo.mcprototype.actiontest.ActionTestHelper._SETMINIMUMACTIONEXECUTIONTIME_OP_NUMBER:
        setMinimumActionExecutionTime((org.ccsds.moims.mo.mal.structures.UInteger) body.getBodyElement(0, new org.ccsds.moims.mo.mal.structures.UInteger()), interaction);
        interaction.sendAcknowledgement();
        break;
      default:
  ...
  public void handleRequest(org.ccsds.moims.mo.mal.provider.MALRequest interaction, org.ccsds.moims.mo.mal.transport.MALMessageBody body) throws org.ccsds.moims.mo.mal.MALInteractionException, org.ccsds.moims.mo.mal.MALException
  {
    switch (interaction.getOperation().getNumber().getValue())
    {
      case org.ccsds.moims.mo.mcprototype.actiontest.ActionTestHelper._ADDACTIONDEFINITION_OP_NUMBER:
        interaction.sendResponse(addActionDefinition((org.ccsds.moims.mo.mc.action.structures.ActionCreationRequest) body.getBodyElement(0, new org.ccsds.moims.mo.mc.action.structures.ActionCreationRequest()), interaction));
        break;
      default:
        interaction.sendError(new org.ccsds.moims.mo.mal.MALStandardError(org.ccsds.moims.mo.mal.MALHelper.UNSUPPORTED_OPERATION_ERROR_NUMBER, new org.ccsds.moims.mo.mal.structures.Union("Unknown operation")));
    }
