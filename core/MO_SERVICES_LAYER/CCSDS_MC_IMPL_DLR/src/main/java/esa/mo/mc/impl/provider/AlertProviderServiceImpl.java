...
public class AlertProviderServiceImpl extends AlertInheritanceSkeleton implements ReconfigurableServiceImplInterface {
     ...
     */
    public Long publishAlertEvent(final MALInteraction interaction, final Long defId,
    ...
    private Long generateAlertDefinition(final AttributeValueList argumentValues, 
        ...
        alertDef.setDescription("This Alert Definition was automatically generated by the Alert service during the publishing of an Alert Event.");
        ...
        AlertCreationRequestList alertCreationDefs = new AlertCreationRequestList();
