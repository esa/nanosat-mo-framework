...
public class HelperAttributes {
     ...
     */
    public static Object string2attribute(Object in, String value) throws IllegalArgumentException {
        if (value == null) {
     ...
     * @throws java.lang.IllegalArgumentException If attributeName == null
     */
    public static Integer attributeName2typeShortForm(String attributeName) throws IllegalArgumentException {
        if (attributeName == null) {
     ...
     */
    public static Serializable blobAttribute2serialObject(Blob obj) throws IOException, IllegalArgumentException {
