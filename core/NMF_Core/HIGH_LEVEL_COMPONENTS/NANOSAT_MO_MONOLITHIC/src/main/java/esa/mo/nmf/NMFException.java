...
/**
 * The NMFException class provides a generic exception class for the NMF to
...
public class NMFException extends Exception {
     ...
     */
    public NMFException(final String message) {
        super(message);
    }
     ...
     */
    public NMFException(final String message, final Throwable cause) {
        super(message, cause);
    }
}
