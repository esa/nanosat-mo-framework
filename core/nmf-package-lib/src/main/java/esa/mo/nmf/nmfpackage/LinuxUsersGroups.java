...
public class HelperNMFPackage {
    ...
    public static String generateLinuxStartAppScript(String mainclass, String jarFilename) throws IOException {
        ...
        str.append("# Pre-defined variables:\n");
        ...
        str.append("exec java $JAVA_OPTS \\\n");
    ...
    public static String generateProviderProperties() throws IOException {
        StringBuilder str = new StringBuilder();
        str.append("#########################################################\n");
        str.append("#  This file was auto-generated by the NMF\n");
        str.append("#  during the installation of this App\n");
        ...
        str.append("helpertools.configurations.OrganizationName=esa\n");
        str.append("helpertools.configurations.provider.app.category=NMF_App\n");
        str.append("\n");
