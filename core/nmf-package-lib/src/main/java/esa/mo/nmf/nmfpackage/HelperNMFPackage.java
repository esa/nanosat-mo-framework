...
public class HelperNMFPackage {
    ...
    public static long calculateCRCFromFile(final String filepath) throws IOException {
        ...
        final long crc = calculateCRCFromInputStream(inputStream);
        inputStream.close();
        return crc;
    }
    ...
    public static String generateLinuxStartAppScript(final String mainclass, final String jarFilename, final String maxHeap) throws IOException {
    ...
    public static String generateProviderProperties(final String runAs) throws IOException {
        final StringBuilder str = new StringBuilder();
        str.append("#########################################################\n");
        str.append("#  This file was auto-generated by the NMF\n");
        str.append("#  during the installation of this App\n");
