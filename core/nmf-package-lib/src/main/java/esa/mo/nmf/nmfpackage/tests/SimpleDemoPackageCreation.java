...
public class SimpleDemoPackageCreation {
    ...
    public static void createPackage() {
        ...
        final String myAppFilename = "myApp.filetype";
        final String dummyFolder = "myInstalledApp";
        ...
        // Package 1
        final NMFPackageDetails details = new NMFPackageDetails("TestPackage", "1.0", timestamp, "noclass", "96m");
        ...
        // Package 2
        final NMFPackageDetails details2 = new NMFPackageDetails("TestPackage", "2.0", timestamp, "noclass", "96m");
        ...
        // Package 3
        final NMFPackageDetails details3 = new NMFPackageDetails("TestPackage", "3.0", timestamp, "noclass", "96m");
