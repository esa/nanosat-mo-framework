...
public class TestCOMService {
  ...
  public void testAddCOMObject2() {
    COMObject input = new COMObject(
        new ObjectType(new UShort(1), new UShort(2), new UOctet((byte) 3), new UShort(4)),
  ...
  public void testGetObjects() {
    COMObject input = new COMObject(
        new ObjectType(new UShort(1), new UShort(2), new UOctet((byte) 3), new UShort(1)),
        new Identifier("Test1"), new Integer(42), false, null, false, null, false);
    uut.addCOMObject(input);
    COMObject input2 = new COMObject(
        new ObjectType(new UShort(1), new UShort(2), new UOctet((byte) 3), new UShort(2)),
        new Identifier("Test2"), new Integer(42), false, null, false, null, false);
