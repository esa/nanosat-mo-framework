...
public class ActivityTrackingProviderServiceImpl
{
    ...
    //------------------------------------------------------------------------------
    public void publishExecutionEventSubmitAck(MALInteraction interaction, boolean success, ObjectId source) throws
    ...
    public void publishExecutionEventRequestResponse(MALInteraction interaction,
                                                     boolean success,
    ...
    public void publishExecutionEventInvokeAck(MALInteraction interaction, boolean success, ObjectId source) throws
                                                                                                             MALInteractionException,
                                                                                                             MALException
    {
    ...
    public void publishExecutionEventInvokeResponse(MALInteraction interaction, boolean success, ObjectId source) throws
                                                                                                                  MALInteractionException,
                                                                                                                  MALException
    {
    ...
    public void publishReleaseEvent(MALInteraction interaction,
                                    boolean success,
                                    Duration nextDuration,
                                    URI nextDestination,
                                    ObjectId source) throws MALInteractionException, MALException
    {
        this.publishTransferEventOperation(interaction,
                                           ActivityTrackingHelper.RELEASE_OBJECT_TYPE,
                                           success,
                                           nextDuration,
                                           nextDestination,
                                           source);
    ...
    public void publishReceptionEvent(MALInteraction interaction,
                                      boolean success,
                                      Duration nextDuration,
                                      URI nextDestination,
                                      ObjectId source) throws MALInteractionException, MALException
    {
        this.publishTransferEventOperation(interaction,
                                           ActivityTrackingHelper.RECEPTION_OBJECT_TYPE,
                                           success,
                                           nextDuration,
                                           nextDestination,
                                           source);
    ...
    public void publishForwardEvent(MALInteraction interaction,
                                    boolean success,
                                    Duration nextDuration,
                                    URI nextDestination,
                                    ObjectId source) throws MALInteractionException, MALException
    {
        this.publishTransferEventOperation(interaction,
                                           ActivityTrackingHelper.FORWARD_OBJECT_TYPE,
                                           success,
                                           nextDuration,
                                           nextDestination,
                                           source);
    ...
    //------------------------------------------------------------------------------
    public void publishExecutionEventSubmitAck(final URI uri,
    ...
    public void publishExecutionEventRequestResponse(final URI uri,
                                                     final Identifier network,
                                                     boolean success,
                                                     ObjectId source) throws MALInteractionException, MALException
    {
    ...
    public void publishExecutionEventInvokeAck(final URI uri,
                                               final Identifier network,
                                               boolean success,
                                               ObjectId source) throws MALInteractionException, MALException
    {
    ...
    public void publishExecutionEventInvokeResponse(final URI uri,
                                                    final Identifier network,
                                                    boolean success,
                                                    ObjectId source) throws MALInteractionException, MALException
    {
    ...
    public void publishReleaseEvent(final URI uri,
                                    final Identifier network,
                                    boolean success,
                                    Duration nextDuration,
                                    URI nextDestination,
                                    ObjectId source) throws MALInteractionException, MALException
    {
        this.publishTransferEventOperation(uri,
                                           network,
                                           ActivityTrackingHelper.RELEASE_OBJECT_TYPE,
                                           success,
                                           nextDuration,
    ...
    public void publishReceptionEvent(final URI uri,
                                      final Identifier network,
                                      boolean success,
                                      Duration nextDuration,
                                      URI nextDestination,
    ...
    public void publishForwardEvent(final URI uri,
                                    final Identifier network,
                                    boolean success,
                                    Duration nextDuration,
                                    URI nextDestination,
    ...
    //------------------------------------------------------------------------------
    public ObjectId publishExecutionEventOperation(MALInteraction interaction,
                                                   boolean success,
                                                   ...
                                                   ObjectId source) throws MALInteractionException, MALException
    {
        return this.publishExecutionEventOperation(interaction,
                                                   null,
                                                   null,
                                                   success,
                                                   currentStageCount,
    ...
    public ObjectId publishExecutionEventOperation(final URI uri,
                                                   final Identifier network,
                                                   boolean success,
                                                   int currentStageCount,
                                                   int totalStageCount,
                                                   ...
                                                   ObjectId source) throws MALInteractionException, MALException
    {
        return this.publishExecutionEventOperation(null,
                                                   uri,
                                                   network,
                                                   success,
                                                   currentStageCount,
    ...
    private ObjectId publishExecutionEventOperation(final MALInteraction interaction,
                                                    final URI uri,
                                                    final Identifier network,
                                                    boolean success,
                                                    int currentStageCount,
                                                    ...
                                                    ObjectId source) throws MALInteractionException, MALException
    {
        ...
        if (interaction != null)
        {
            objId = eventService.generateAndStoreEvent(ActivityTrackingHelper.EXECUTION_OBJECT_TYPE,
                                                       ...
                                                       interaction);
            sourceURI =
                    (interaction.getMessageHeader() != null) ? interaction.getMessageHeader().getURITo() : new URI("");
        }
        else
        {
            objId = eventService.generateAndStoreEvent(ActivityTrackingHelper.EXECUTION_OBJECT_TYPE,
        ...
        {
            eventService
                    .publishEvent(sourceURI, objId, ActivityTrackingHelper.EXECUTION_OBJECT_TYPE, related, source, ael);
        }
    ...
    public Long publishTransferEventOperation(MALInteraction interaction,
                                              ...
                                              final URI nextDestination,
                                              final ObjectId source) throws MALInteractionException, MALException
    {
        return this.publishTransferEventOperation(interaction,
                                                  null,
                                                  null,
                                                  objType,
                                                  success,
    ...
    public Long publishTransferEventOperation(final URI uri,
                                              final Identifier network,
                                              final ObjectType objType,
                                              final boolean success,
                                              final Duration duration,
    ...
    {
        return this
                .publishTransferEventOperation(null, uri, network, objType, success, duration, nextDestination, source);
    }

    private Long publishTransferEventOperation(MALInteraction interaction,
                                               final URI uri,
                                               final Identifier network,
                                               final ObjectType objType,
                                               final boolean success,
                                               ...
                                               final ObjectId source) throws MALInteractionException, MALException
    {
        ...
        if (interaction != null)
        {
            objId = eventService.generateAndStoreEvent(objType,
                                                       ConfigurationProviderSingleton.getDomain(),
                                                       atl,
                                                       null,
                                                       source,
        ...
        {
            Logger.getLogger(ActivityTrackingProviderServiceImpl.class.getName())
                    .log(Level.SEVERE, null, "Could not publish the Event!");
        }

        return objId;
    }

    public Long publishAcceptanceEventOperation(MALInteraction interaction,
                                                boolean success,
                                                final Long related,
                                                final ObjectId source) throws MALInteractionException, MALException
    {
    ...
    public Long publishAcceptanceEventOperation(final URI uri,
                                                final Identifier network,
                                                boolean success,
                                                final Long related,
                                                final ObjectId source) throws MALInteractionException, MALException
                                                ...
                                                final ObjectId source) throws MALInteractionException, MALException
    {
        ...
        {
            eventService
                    .publishEvent(sourceURI, objId, ActivityTrackingHelper.ACCEPTANCE_OBJECT_TYPE, null, source, aal);
        }
        catch (IOException ex)
        {
            Logger.getLogger(ActivityTrackingProviderServiceImpl.class.getName())
     ...
     * @param source      The source link of the Operation Activity object. Can be null
     * @return The link to the stored COM Operation Activity. Null if not stored.
     */
    public ObjectId storeCOMOperationActivity(final MALInteraction interaction, final ObjectId source)
    {
        ...
        archiveDetails.get(0)
                .setNetwork(interaction.getMessageHeader().getNetworkZone());  // RID raised to create this requirement!
        archiveDetails.get(0)
                .setProvider(interaction.getMessageHeader().getURIFrom());     // RID raised to create this requirement!

        executor.execute(() -> {
            try
            {
                archiveService.store(false,
