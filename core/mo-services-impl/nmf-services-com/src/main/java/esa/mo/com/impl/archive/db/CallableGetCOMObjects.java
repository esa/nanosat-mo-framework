...
public final class CallableGetCOMObjects implements Callable<List<COMObjectEntity>> {
    ...
    CallableGetCOMObjects(TransactionsProcessor transactionsProcessor,
            LongList ids, Integer domainId, Integer objTypeId) {
        ...
        try {
            ...
            while (rs.next()) {
                perObjs.add(new COMObjectEntity((Integer) rs.getObject(1), (Integer) rs.getObject(2),
                        ...
                        (Integer) rs.getObject(5), (Integer) rs.getObject(6),
                        new SourceLinkContainer((Integer) rs.getObject(7),
