...
public class PackageManagementConsumerServiceImpl extends ConsumerServiceImpl {
    ...
    public PackageManagementConsumerServiceImpl(final SingleConnectionDetails connectionDetails, final COMServicesConsumer comServices) throws MALException, MalformedURLException, MALInteractionException {
        this(connectionDetails, comServices, null, null);
    }

    public PackageManagementConsumerServiceImpl(final SingleConnectionDetails connectionDetails, final COMServicesConsumer comServices,
