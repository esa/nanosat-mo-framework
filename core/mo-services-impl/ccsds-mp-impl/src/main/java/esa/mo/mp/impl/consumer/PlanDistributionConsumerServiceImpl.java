...
public class PlanDistributionConsumerServiceImpl extends ConsumerServiceImpl {
    ...
    public PlanDistributionConsumerServiceImpl(final SingleConnectionDetails connectionDetails, final COMServicesConsumer comServices) throws MALException, MalformedURLException {
