...
public class MCServicesHelper {
    ...
    private static final ObjectType alertDefObjType = new ObjectType(AlertDefinitionDetails.AREA_SHORT_FORM,
                                                                     AlertDefinitionDetails.SERVICE_SHORT_FORM,
                                                                     AlertDefinitionDetails.AREA_VERSION, new UShort(
    ...
    private static final ObjectType alertEventObjType = new ObjectType(AlertEventDetails.AREA_SHORT_FORM,
                                                                       ...
                                                                       AlertEventDetails.AREA_VERSION, new UShort(
                                                                                                                  ALERT_EVENT_OBJECT_NUMBER));
    ...
    private static final ObjectType actionDefObjType = new ObjectType(ActionDefinitionDetails.AREA_SHORT_FORM,
                                                                      ActionDefinitionDetails.SERVICE_SHORT_FORM,
                                                                      ActionDefinitionDetails.AREA_VERSION, new UShort(
    ...
    private static final ObjectType actionFailureObjType = new ObjectType(MCHelper.MC_AREA_NUMBER,
                                                                          ...
                                                                          MCHelper.MC_AREA_VERSION, new UShort(
                                                                                                               ACTION_FAILURE_OBJECT_NUMBER));
    ...
    private static final ObjectType activityReleaseObjType = new ObjectType(ActivityTransfer.AREA_SHORT_FORM,
                                                                            ...
                                                                            ActivityTransfer.AREA_VERSION, new UShort(
                                                                                                                      ACTIVITY_RELEASE_OBJECT_NUMBER));
    ...
    //conversion objects
    private static final ObjectType conversionIdentityObjType = new ObjectType(DiscreteConversionDetails.AREA_SHORT_FORM,
    ...
    private static final ObjectType discreteConversionObjType = new ObjectType(DiscreteConversionDetails.AREA_SHORT_FORM,
                                                                               DiscreteConversionDetails.SERVICE_SHORT_FORM,
                                                                               DiscreteConversionDetails.AREA_VERSION,
    ...
    private static final ObjectType statisticLinkObjType = new ObjectType(StatisticLinkDetails.AREA_SHORT_FORM,
                                                                          ...
                                                                          StatisticLinkDetails.AREA_VERSION, new UShort(
                                                                                                                        STATISTIC_LINK_OBJECT_NUMBER));

    private static final ObjectType statisticLinkDefinitionObjType = new ObjectType(StatisticLinkDetails.AREA_SHORT_FORM,
                                                                                    StatisticLinkDetails.SERVICE_SHORT_FORM,
    ...
    //parameter objects
    private static final ObjectType parameterIdentityObjType = new ObjectType(ParameterDefinitionDetails.AREA_SHORT_FORM,
    ...
    private static final ObjectType parameterDefinitionDetailsObjType = new ObjectType(ParameterDefinitionDetails.AREA_SHORT_FORM,
                                                                                       ParameterDefinitionDetails.SERVICE_SHORT_FORM,
                                                                                       ParameterDefinitionDetails.AREA_VERSION,
    ...
    private static final ObjectType parameterValueObjType = new ObjectType(ParameterValue.AREA_SHORT_FORM,
                                                                           ...
                                                                           ParameterValue.AREA_VERSION, new UShort(
    ...
    private static final ObjectType deltaCheckObjType = new ObjectType(DeltaCheckDefinition.AREA_SHORT_FORM,
                                                                       ...
                                                                       DeltaCheckDefinition.AREA_VERSION, new UShort(
    ...
    private static final ObjectType limitCheckObjType = new ObjectType(LimitCheckDefinition.AREA_SHORT_FORM,
                                                                       ...
                                                                       LimitCheckDefinition.AREA_VERSION, new UShort(
    ...
    private static final ObjectType checkTransitionObjType = new ObjectType(CheckResult.AREA_SHORT_FORM,
                                                                            ...
                                                                            CheckResult.AREA_VERSION, new UShort(
                                                                                                                 CHECK_TRANSITION_OBJECT_NUMBER));

    //aggregation objects
    private static final ObjectType aggregationIdentityObjType = new ObjectType(AggregationDefinitionDetails.AREA_SHORT_FORM,
    ...
    private static final ObjectType aggregationDefinitionObjType = new ObjectType(AggregationDefinitionDetails.AREA_SHORT_FORM,
                                                                                  AggregationDefinitionDetails.SERVICE_SHORT_FORM,
                                                                                  AggregationDefinitionDetails.AREA_VERSION,
                                                                                  new UShort(AGGREGATION_DEFINITION_OBJECT_NUMBER));

    private static final ObjectType aggregationValueInstanceObjType = new ObjectType(AggregationDefinitionDetails.AREA_SHORT_FORM,
                                                                                     AggregationDefinitionDetails.SERVICE_SHORT_FORM,
                                                                                     AggregationDefinitionDetails.AREA_VERSION,
    ...
    static public EntityKey generateEntityKey(ObjectType objectType, long instanceNumber, ObjectType sourceObjectType) {
        return new EntityKey(new Identifier(String.valueOf(objectType.getNumber())), MCServicesHelper.generateSubKey(
                                                                                                                     objectType,
                                                                                                                     false),
                             instanceNumber, MCServicesHelper.generateSubKey(sourceObjectType, true));
