...
public class ActionConsumerServiceImpl extends ConsumerServiceImpl {
    ...
    public ActionConsumerServiceImpl(final SingleConnectionDetails connectionDetails, final COMServicesConsumer comServices) throws MALException, MalformedURLException, MALInteractionException {
        this(connectionDetails, comServices, null, null);
    }

    public ActionConsumerServiceImpl(final SingleConnectionDetails connectionDetails, final COMServicesConsumer comServices,
