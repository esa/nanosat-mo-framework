...
public class AggregationProviderServiceImpl extends AggregationInheritanceSkeleton implements ReconfigurableService {
    ...
    public synchronized void init(COMServicesProvider comServices,
        ...
        storeAggregationsInCOMArchive = Boolean.parseBoolean(System.getProperty(MCServicesHelper.STORE_IN_ARCHIVE_PROPERTY,
                                                                                "true"));
    ...
    public AggregationValueDetailsList getValue(final LongList inIdentityIds,
                                                final MALInteraction interaction) throws MALException, MALInteractionException { // requirement 3.7.6.2.1
    ...
    @Override
    public ObjectInstancePairList listDefinition(final IdentifierList nameList,
                                                 final MALInteraction interaction) throws MALException, MALInteractionException { // requirement: 3.7.9.2.1
    ...
    public Boolean reloadConfiguration(ConfigurationObjectDetails configurationObjectDetails) {
        ...
        AggregationDefinitionDetailsList pDefs = (AggregationDefinitionDetailsList) HelperArchive.getObjectBodyListFromArchive(manager.getArchiveService(),
                                                                                                                               AggregationHelper.AGGREGATIONDEFINITION_OBJECT_TYPE,
                                                                                                                               ConfigurationProviderSingleton.getDomain(),
