...
public class MCSupervisorBasicAdapter extends MonitorAndControlNMFAdapter{
  ...
  @Parameter(
      ...
      onGetFunction = "onGetOSVersion",
      readOnly = true,
      reportIntervalSeconds = 10)
  public String OSVersion = "";

  @Parameter(
      description = "The Current partition where the OS is running. Only works for linux",
      generationEnabled = false,
      onGetFunction = "onGetOSPartition",
      readOnly = true,
      reportIntervalSeconds = 10)
  ...
  @Action(
      name="Clock.setTimeUsingDeltaMilliseconds",
  ...
  public UInteger setTimeUsingDeltaMilliseconds(
      ...
      boolean reportProgress,
      MALInteraction interaction,
      @ActionParameter(name="arg", rawUnit = "milliseconds") Long delta)
  {
