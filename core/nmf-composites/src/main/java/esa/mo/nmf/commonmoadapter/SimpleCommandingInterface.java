...
public interface SimpleCommandingInterface {
    ...
    /**
     * Toggle the generation of the given parameters. Their values can then be
     * received using the addDataReceivedListener() method.
     *
     * @param parameterNames Names of the parameters to toggle the generation
     * for
     * @param reportingEnabled Whether to enable or disable the parameters
     * generation
     * @throws NMFException in case something goes wrong
     */
    void toggleParametersGeneration(
            List<String> parameterNames, boolean reportingEnabled)
            throws NMFException;
     ...
     * @return The id of the execution of an action. This can be used to track
     * the action via the Activity Tracking service.
     */
     ...
     * action using the Action service by selecting the definitionId of the
     * action and the respective argument values necessary for the execution of
     * that action.
     *
     ...
     * @throws NMFException in case something goes wrong
     */
    Long launchAction(Long definitionId, AttributeValueList argumentValues,
