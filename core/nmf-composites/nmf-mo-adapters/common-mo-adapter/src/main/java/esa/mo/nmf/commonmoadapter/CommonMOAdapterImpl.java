...
public class CommonMOAdapterImpl extends NMFConsumer implements SimpleCommandingInterface {
     ...
     */
    public CommonMOAdapterImpl(final ConnectionConsumer connection, final Blob authenticationId,
     ...
     * @param localNamePrefix the prefix for the local name of the consumer
     */
    public CommonMOAdapterImpl(final ProviderSummary providerDetails, final Blob authenticationId,
                               final String localNamePrefix) {
    ...
    public void setParameter(final String parameterName, final Serializable content) {
        ...
        try {
            ...
            if (objId == null) {
                ...
                parameterDefinition.setDescription("This Definition was automatically generated by: " +
    ...
    public void addDataReceivedListener(final DataReceivedListener listener) {
                ...
                if (lAggregationValueList.size() == lUpdateHeaderList.size()) {
                    for (int i = 0; i < lUpdateHeaderList.size(); i++) {
                        ...
                        if (listener instanceof CompleteAggregationReceivedListener) {
                            ...
                            AggregationInstance aggregationInstance = new AggregationInstance(new Identifier(aggregationName),
                                                                                              aggregationValue, source,
                                                                                              timestamp);
        ...
        if (listener instanceof SimpleDataReceivedListener || listener instanceof CompleteDataReceivedListener) {
            ...
            try {
                ...
                super.getMCServices().getParameterService()
                                     .getParameterStub()
                                     .monitorValueRegister(this.parameterSubscription,
                                                           new DataReceivedParameterAdapter());
            } catch (MALInteractionException | MALException ex) {
                LOGGER.log(Level.SEVERE, null, ex);
            } catch (NullPointerException ex) {
                LOGGER.log(Level.SEVERE, "Null pointer exception when trying to access the Parameter service. " +
                                         "Check if the service consumer was initialized with a proper URI.", ex);
            }
        }
        if (listener instanceof SimpleAggregationReceivedListener ||
            ...
            try {
                ...
                super.getMCServices().getAggregationService()
                                     .getAggregationStub()
                                     .monitorValueRegister(this.aggregationSubscription,
                                                           new DataReceivedAggregationAdapter());
            } catch (MALInteractionException | MALException ex) {
                LOGGER.log(Level.SEVERE, null, ex);
            } catch (NullPointerException ex) {
                LOGGER.log(Level.SEVERE, "Null pointer exception when trying to access the Aggregation service. " +
                                         "Check if the service consumer was initialized with a proper URI.", ex);
            }
        }
    }
    ...
    public Long launchAction(final String actionName, final Serializable[] objects) {
        ...
        try {
            ...
            if (objId == null) {
                ...
                actionDefinition.setDescription("This Definition was automatically generated by: " +
                                                CommonMOAdapterImpl.class.getName());
    ...
    public Long launchAction(Long defInstId, AttributeValueList argumentValues,
        ...
        try {
            ActionInstanceDetails instanceDetails = new ActionInstanceDetails(defInstId, stageStartedRequired,
                                                                              stageProgressRequired,
                                                                              stageCompletedRequired, argumentValues,
                                                                              argumentIds, null);
            ...
            ArchiveDetailsList archiveDetailsListActionInstance = HelperArchive.generateArchiveDetailsList(related,
                                                                                                           source,
            ...
            LongList objIdActionInstances = super.getCOMServices().getArchiveService()
                                                                  .getArchiveStub()
                                                                  .store(returnObjInstIds,
            ...
            MALMessage msg = super.getMCServices().getActionService()
                                                  .getActionStub()
                                                  .asyncSubmitAction(instanceObjId, instanceDetails, actionAdapter);
            ...
            ArchiveDetailsList archiveDetailsListOp = HelperArchive.generateArchiveDetailsList(related, source,
                                                                                               actionConnection.getProviderURI());
            ...
            try {
                ...
                super.getCOMServices().getArchiveService()
                                      .getArchiveStub()
                                      .store(returnObjInstIds, ActivityTrackingHelper.OPERATIONACTIVITY_OBJECT_TYPE,
                                             actionConnection.getDomain(), archiveDetailsListOp, opActivityList);
            } catch (MALInteractionException ex) {
            ...
            super.getCOMServices().getArchiveService()
                                  .getArchiveStub()
                                  .update(ActionHelper.ACTIONINSTANCE_OBJECT_TYPE, actionConnection.getDomain(),
    ...
    /** {@inheritDoc} */
    @Override
    public void toggleParametersGeneration(List<String> parameterNames, boolean enableGeneration) throws NMFException {
        ...
        try {
            ...
            if (objIds == null) {
                throw new NMFException(String.format("Error while toggling parameters generation, couldn't get parameters instance IDs (unknown error) for parameters names: %s",
                                                     paramNames));
            }
            ...
            if (objIds.size() < parameterNames.size()) {
                if (objIds.size() <= 0) {
                    throw new NMFException(String.format("Error while toggling parameters generation, 0 parameters instance IDs found for parameters names: %s",
                                                         paramNames));
                } else {
