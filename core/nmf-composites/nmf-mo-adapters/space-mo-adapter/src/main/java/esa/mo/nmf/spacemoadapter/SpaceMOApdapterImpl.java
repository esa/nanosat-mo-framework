...
public class SpaceMOApdapterImpl extends CommonMOAdapterImpl {
   ...
   */
  public SpaceMOApdapterImpl(final ConnectionConsumer connection, final Blob authenticationId, final String localNamePrefix)
  {
   ...
   * @param localNamePrefix the prefix for the local name of the consumer
   */
  public SpaceMOApdapterImpl(final ProviderSummary providerDetails, final Blob authenticationId, final String localNamePrefix)
  {
