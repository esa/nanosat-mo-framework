 ...
 *  ----------------------------------------------------------------------------
 */
package esa.mo.nmf.mission.orekit.simulator.tcp;
 ...
 * ({@code esa.mo.nmf.mission.orekit.simulator.**}) plus the JDK types.
 * Deserialization only resolves these names against the client's own
 * classpath — it never defines classes from the incoming bytes — so an
 * allowed name can only ever resolve to a class
...
public final class SimulatorSerialFilter {
    ...
    private static final String SERVER_PATTERN = String.join(";",
            LIMITS,
            "esa.mo.nmf.mission.orekit.simulator.util.CommandDescriptor",
            "esa.mo.nmf.mission.orekit.simulator.util.CommandResult",
            "esa.mo.nmf.mission.orekit.simulator.util.ArgumentDescriptor",
            "esa.mo.nmf.mission.orekit.simulator.util.ArgumentTemplate",
            JDK_SCALARS,
            "java.util.ArrayList",
     ...
     * data live across {@code esa.mo.nmf.mission.orekit.simulator.**}) plus
     * the JDK types they carry.
     */
    private static final String CLIENT_PATTERN = String.join(";",
            LIMITS,
            "esa.mo.nmf.mission.orekit.simulator.**",
            JDK_SCALARS,
            "java.util.ArrayList",
            "java.util.LinkedList",
            "java.util.HashMap",
