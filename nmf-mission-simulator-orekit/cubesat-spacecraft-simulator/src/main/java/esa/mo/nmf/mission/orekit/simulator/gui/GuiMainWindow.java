 ...
 *  ----------------------------------------------------------------------------
 */
package esa.mo.nmf.mission.orekit.simulator.gui;
...
import esa.mo.nmf.mission.orekit.simulator.util.*;
...
public class GuiMainWindow implements Runnable {
    ...
    private void createAndShowGUI() {
        ...
        sl_panelCameraSettings.putConstraint(SpringLayout.NORTH, lblMode, 10, SpringLayout.NORTH, panelCameraSettings);
        sl_panelCameraSettings.putConstraint(SpringLayout.NORTH, selectMode, -4, SpringLayout.NORTH, lblMode);
        sl_panelCameraSettings.putConstraint(SpringLayout.WEST, selectMode, 10, SpringLayout.EAST, lblMode);
        sl_panelCameraSettings.putConstraint(SpringLayout.EAST, selectMode, 120, SpringLayout.EAST, lblMode);
        sl_panelCameraSettings.putConstraint(SpringLayout.WEST, lblMode, 5, SpringLayout.WEST, panelCameraSettings);
        ...
        sl_panelCameraSettings.putConstraint(SpringLayout.NORTH, textFieldPath, 5, SpringLayout.SOUTH, selectMode);
        sl_panelCameraSettings.putConstraint(SpringLayout.WEST, textFieldPath, 0, SpringLayout.WEST, lblMode);
        sl_panelCameraSettings.putConstraint(SpringLayout.EAST, textFieldPath, 0, SpringLayout.EAST, selectMode);
        ...
        btnOpenTargetSelect.addActionListener(arg0 -> {
            if (targetURL.equals("127.0.0.1")) { // browse locally
                ...
                if (selectMode.getSelectedItem().equals("Fixed")) {
                    ...
                    fc.setFileFilter(new FileNameExtensionFilter("Image files", "jpg", "jpeg", "png", "bmp", "raw"));
                } else {
        ...
        tableCurrentSettings.setModel(new DefaultTableModel(new Object[][]{}, new String[]{"Property", "Value"}) {
