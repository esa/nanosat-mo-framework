...
exec java -Djava.util.logging.config.file="$NMF_HOME/etc/logging.properties" -classpath "$JARS_MISSION*:$JARS_NMF*" esa.mo.nmf.mission.orekit.simulator.main.MainClient "$@"
