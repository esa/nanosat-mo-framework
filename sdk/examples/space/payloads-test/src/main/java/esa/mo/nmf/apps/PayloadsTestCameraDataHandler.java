...
public class PayloadsTestCameraDataHandler extends CameraAdapter
{
  ...
  PayloadsTestCameraDataHandler(final Long actionInstanceObjId,
  ...
  @Override
  public void takeAutoExposedPictureAckReceived(final MALMessageHeader msgHeader, final Map qosProperties)
  {
          ...
          final java.util.Map qosProperties)
  {
    ...
    try {
      ...
      if (picture.getSettings().getFormat().equals(PictureFormat.RAW)) {
        final FileOutputStream fos = new FileOutputStream(filenamePrefix + "myPicture.raw");
        ...
        final FileOutputStream fos = new FileOutputStream(filenamePrefix + "myPicture.png");
        fos.write(picture.getContent().getValue());
        fos.flush();
        fos.close();
        ...
        final FileOutputStream fos = new FileOutputStream(filenamePrefix + "myPicture.bmp");
        fos.write(picture.getContent().getValue());
        fos.flush();
        fos.close();
        ...
        final FileOutputStream fos = new FileOutputStream(filenamePrefix + "myPicture.jpg");
        fos.write(picture.getContent().getValue());
        fos.flush();
        fos.close();
  ...
  @Override
  public void takeAutoExposedPictureResponseReceived(final MALMessageHeader msgHeader, final Picture picture,
  ...
  @Override
  public void takeAutoExposedPictureAckErrorReceived(final MALMessageHeader msgHeader,
  ...
  @Override
  public void takeAutoExposedPictureResponseErrorReceived(final MALMessageHeader msgHeader,
                                                          final MALStandardError error, final Map qosProperties)
  {
