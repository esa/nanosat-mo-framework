...
public class ActivityDefTablePanel extends SharedTablePanel {
    ...
    public ActivityDefTablePanel(final ArchiveConsumerServiceImpl archiveService) {
    ...
    public void addEntry(final Identifier identity, final ArchivePersistenceObject comObject) {
        ...
        final ActivityDefinitionDetails definition = (ActivityDefinitionDetails) comObject.getObject();
