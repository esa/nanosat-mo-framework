...
public final class COMObjectWindow extends javax.swing.JDialog {
    ...
    public COMObjectWindow(final ArchivePersistenceObject comObject, final boolean editable,
        ...
        if (archiveDetails != null) {
            ...
            if (source == null) {
                ...
                // Source
                this.sourceType.setText(HelperCOM.objType2string(comObject.getArchiveDetails()
                                                                          .getDetails()
                                                                          .getSource()
                                                                          .getType()));
                this.sourceType1.setText(comObject.getArchiveDetails()
                                                  .getDetails()
                                                  .getSource()
                                                  .getType()
                                                  .getArea()
                                                  .toString());
                this.sourceType2.setText(comObject.getArchiveDetails()
                                                  .getDetails()
                                                  .getSource()
                                                  .getType()
                                                  .getService()
                                                  .toString());
                this.sourceType3.setText(comObject.getArchiveDetails()
                                                  .getDetails()
                                                  .getSource()
                                                  .getType()
                                                  .getVersion()
                                                  .toString());
                this.sourceType4.setText(comObject.getArchiveDetails()
                                                  .getDetails()
                                                  .getSource()
                                                  .getType()
                                                  .getNumber()
                ...
                this.sourceDomain.setText(HelperMisc.domain2domainId(comObject.getArchiveDetails()
                                                                              .getDetails()
                                                                              .getSource()
                                                                              .getKey()
                                                                              .getDomain()));
                this.sourceObjId.setText(comObject.getArchiveDetails()
                                                  .getDetails()
                                                  .getSource()
                                                  .getKey()
                                                  .getInstId()
    ...
    private void initComponents() {
                                                                                ...
                                                                                .addGroup(topPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING,
                                                                                                        ...
                                                                                                        .addGroup(topPanelLayout.createSequentialGroup()
                                                                                                                                .addComponent(objIdentification1,
                                                                                                                                              ...
                                                                                                                                              javax.swing.GroupLayout.PREFERRED_SIZE)
                                                                                                                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                                                                                                                .addComponent(tfObjectType1,
                                                                                                                                              javax.swing.GroupLayout.PREFERRED_SIZE,
                                                                                                                                              25,
                                                                                                                                              javax.swing.GroupLayout.PREFERRED_SIZE)
                                                                                                                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                                                                                                                .addComponent(tfObjectType2,
                                                                                                                                              javax.swing.GroupLayout.PREFERRED_SIZE,
                                                                                                                                              25,
                                                                                                                                              javax.swing.GroupLayout.PREFERRED_SIZE)
                                                                                                                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                                                                                                                .addComponent(tfObjectType3,
                                                                                                                                              javax.swing.GroupLayout.PREFERRED_SIZE,
                                                                                                                                              25,
                                                                                                                                              javax.swing.GroupLayout.PREFERRED_SIZE)
                                                                                                                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                                                                                                                .addComponent(tfObjectType4,
                                                                                                                                              javax.swing.GroupLayout.PREFERRED_SIZE,
                                                                                                                                              25,
                                                                                                                                              javax.swing.GroupLayout.PREFERRED_SIZE)
                                                                                                                                .addGap(18,
        ...
        componentsPanelLayout.setHorizontalGroup(componentsPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                                                                                                                    ...
                                                                                                                                    .addGroup(componentsPanelLayout.createSequentialGroup()
                                                                                                                                                                   .addGroup(componentsPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING,
                                                                                                                                                                                                  ...
                                                                                                                                                                                                  .addComponent(jLabel7,
                                                                                                                                                                                                                ...
                                                                                                                                                                                                                280,
                                                                                                                                                                                                                Short.MAX_VALUE)
                                                                                                                                                                                                  .addComponent(tfNetwork,
                                                                                                                                                                                                                javax.swing.GroupLayout.DEFAULT_SIZE,
                                                                                                                                                                                                                280,
                                                                                                                                                                                                                Short.MAX_VALUE)
                                                                                                                                                                                                  .addComponent(tfTimestamp,
                                                                                                                                                                                                                javax.swing.GroupLayout.DEFAULT_SIZE,
                                                                                                                                                                                                                280,
                                                                                                                                                                                                                Short.MAX_VALUE))
                                                                                                                                                                   .addGroup(componentsPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                                                                                                                                                   ...
                                                                                                                                                                   .addGroup(componentsPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                                                                                                                                                                                  ...
                                                                                                                                                                                                  .addGroup(componentsPanelLayout.createSequentialGroup()
                                                                                                                                                                                                                                 ...
                                                                                                                                                                                                                                 .addGap(0,
                                                                                                                                                                                                                                         ...
                                                                                                                                                                                                                                         Short.MAX_VALUE)))))
                                                                                                     .addContainerGap()));
        componentsPanelLayout.setVerticalGroup(componentsPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
