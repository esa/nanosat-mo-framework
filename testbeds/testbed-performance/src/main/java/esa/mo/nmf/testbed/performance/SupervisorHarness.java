...
/**
 * Manages the lifecycle of an NMF Supervisor process for performance tests.
 *
 * <p>
 * The filesystem used is generated fresh during the build
 * (generate-test-resources phase) and its root path is read from the
 * {@code nmf.perf.filesystem} system property injected by the Surefire
...
public class SupervisorHarness {
     ...
     * it is ready (Directory service URI appears in stdout).
     *
